...
void wifi_init_sta(void)
{
    ...
    //3. inicializamos como  station ,y pasamos como refereencia el esp_netif_t a dhco stop
    esp_netif_t *ret = esp_netif_create_default_wifi_sta();
    esp_netif_dhcpc_stop(ret);

    esp_netif_ip_info_t ip_info;
    ip_info.ip.addr = esp_ip4addr_aton("192.168.1.249") ;
